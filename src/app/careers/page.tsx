            ...
            {state.success ? (
              <div className="text-center py-12">
                ...
                <div className="flex flex-col items-center gap-6">
                  ...
                  <div className="bg-[#141312] p-6 rounded-2xl border border-[#282624] w-full max-w-sm mb-2 shadow-lg">
                  ...
                  <button 
                    ...
                    className="text-sm font-semibold transition-all hover:text-white mt-4"
                    style={{ color: '#a39e98' }}
                  >
