...
export default function AnyRoleSection() {
  ...
  return (
    <section className="py-24 lg:py-32 relative overflow-hidden bg-premium-grid" style={{ backgroundColor: '#0c0b0a', borderBottom: '1px solid #1a1918' }}>
      
      {/* ── Animated Background Blobs ── */}
      <div className="absolute top-0 right-1/4 w-[400px] h-[400px] bg-[#f3c892] rounded-full mix-blend-screen filter blur-[120px] opacity-[0.05] animate-blob pointer-events-none" />
      <div className="absolute bottom-0 left-1/4 w-[400px] h-[400px] bg-[#e5b980] rounded-full mix-blend-screen filter blur-[120px] opacity-[0.05] animate-blob animation-delay-2000 pointer-events-none" />
